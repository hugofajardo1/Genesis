...
import com.ar.genesis.sistema.movimiento.service.controller.MovimientoObtenerEntreFechasController;
...
@SpringBootTest
public class MovimientoObtenerEntreFechasControllerTest {
    @Mock
    ...
    public void obtenerMovimientoEntreFechas_DevuelveMovimiento() {
        ...
        when(miMovimientoObtenerEntreFechasInput.obtenerMovimientosEntreFechas(LocalDate.of(2020,12,1), LocalDate.of(2020,12,31))).thenReturn(movimientos);

        MovimientoObtenerEntreFechasController movimientoObtenerEntreFechasController = new MovimientoObtenerEntreFechasController(miMovimientoObtenerEntreFechasInput);
        ResponseEntity<?> responseEntity = movimientoObtenerEntreFechasController.obtenerMovimientosEntreFechas(LocalDate.of(2020,12,1), LocalDate.of(2020,12,31));
    ...
    public void obtenerMovimientoEntreFechas_DevuelveNull() {
        ...
        when(miMovimientoObtenerEntreFechasInput.obtenerMovimientosEntreFechas(LocalDate.of(2020,11,1), LocalDate.of(2020,11,30))).thenReturn(movimientos);
