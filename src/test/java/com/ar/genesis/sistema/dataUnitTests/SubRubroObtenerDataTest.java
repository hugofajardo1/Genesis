...
import com.ar.genesis.sistema.persistence.repositoryImplementacion.SubRubroRepoImplmentacion;
...
public class SubRubroObtenerDataTest {
    @Inject
    SubRubroRepoImplmentacion miSubRubroObtenerRepoImplmentacion;
