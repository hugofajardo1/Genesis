...
INSERT INTO movimientos(id, sucursalid, puntoventaid, tipooperacionid, tipomovimientoid, imputa, numero, fichaid, tipoivaid, cuit, fecha, hora, montoneto, montototal, saldo) VALUES (nextval('seq_movimientos'), 1, 1, 1, 1, 'Debe', 1, 1, 1, '20255071336', '2020/12/26', '18:00:00', 100.0, 121.0, 121.0);
...
INSERT INTO movimientos(id, sucursalid, puntoventaid, tipooperacionid, tipomovimientoid, imputa, numero, fichaid, tipoivaid, cuit, fecha, hora, montoneto, montototal, saldo) VALUES (nextval('seq_movimientos'), 1, 1, 1, 1, 'Debe', 1, 1, 1, '20255071336', '2021/01/01', '18:00:00', 100.0, 121.0, 121.0);
INSERT INTO movimientositem(id, productoid, cantidad, iva, preciocosto, precioventa, precioventafinal, movimientoid) VALUES (nextval('seq_movimientositem'), 1, 1, 21.0, 100.0, 163.35, 163.35, 1);