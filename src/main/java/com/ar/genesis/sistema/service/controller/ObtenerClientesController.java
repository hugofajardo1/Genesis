...
public class ObtenerClientesController {
    ...
    public ResponseEntity<?> obtenerClientes(){
        try{
            ...
            iObtenerClientesInput.obtenerClientes().forEach(cliente -> clientesDTO.add(new ClienteDTO(cliente.getId(), cliente.getNombre(), cliente.getDomicilio(), cliente.getTelefono())));
