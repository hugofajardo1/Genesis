...
public class PuntoVentaModificarController {
    ...
    public ResponseEntity<?> modificarPuntoVenta(@RequestBody PuntoVentaDTO unPuntoVentaDTO){
        try{
            boolean resultado = this.miPuntoVentaModificarInput.modificarPuntoVenta(PuntoVenta.instancia(unPuntoVentaDTO.getId(), unPuntoVentaDTO.getNombre(), unPuntoVentaDTO.getTipofacturacion()));
