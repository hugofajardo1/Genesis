...
@Service
@Transactional
public class TipoIvaUseCaseModificar implements ITipoIvaModificarInput {

    ITipoIvaRepository miTipoIvaRepository;

    public TipoIvaUseCaseModificar(ITipoIvaRepository miTipoIvaRepository) { this.miTipoIvaRepository = miTipoIvaRepository; }
