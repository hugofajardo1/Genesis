...
@Service
@Transactional
public class TipoMovimientoUseCaseCrear implements ITipoMovimientoCrearInput {

    ITipoMovimientoRepository miTipoMovimientoRepository;

    public TipoMovimientoUseCaseCrear(ITipoMovimientoRepository miTipoMovimientoRepository) {  this.miTipoMovimientoRepository = miTipoMovimientoRepository; }
