...
@Service
@Transactional
public class TipoMovimientoUseCaseModificar implements ITipoMovimientoModificarInput {

    ITipoMovimientoRepository miTipoMovimientoRepository;

    public TipoMovimientoUseCaseModificar(ITipoMovimientoRepository miTipoMovimientoRepository) { this.miTipoMovimientoRepository = miTipoMovimientoRepository; }
